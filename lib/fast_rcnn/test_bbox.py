...
class SolverWrapper(object):
    ...
    def train_model(self, sess, max_iters, restore=False, isTrain=True):
        ...
        rpn_label, rpn_cls_score, \
        rpn_bbox_pred, rpn_bbox_targets = self.net.build_loss(
            ohem=cfg.TRAIN.OHEM)
        ...
        for iter in range(restore_iter, max_iters):
            ...
            if isTrain:
                ...
                rpn_label_val, rpn_cls_score_val, \
                rpn_bbox_pred_val, rpn_bbox_targets_val, \
            ...
            if (iter) % (cfg.TRAIN.DISPLAY) == 0:
                if isTrain:
                    ...
                    if list(rpn_label_val.flatten()) and list(rpn_cls_score_val):
                        confusion_batch_val = confusion_matrix(rpn_label_val.flatten(), rpn_cls_score_val,
                                                               labels=[0, 1, 2])

...
# Images to use per minibatchRPN_BATCHSIZE
...
# __C.TRAIN.RPN_FG_FRACTION = 0.5  # modified by Guangyu, 3 classes need more fg fraction.
__C.TRAIN.RPN_FG_FRACTION = 0.67
# Total number of examples
# __C.TRAIN.RPN_BATCHSIZE = 256 # modified by guangyu to 128 we want 3 classes balance.
__C.TRAIN.RPN_BATCHSIZE = 128
# NMS threshold used on RPN proposals
__C.TRAIN.RPN_NMS_THRESH = 0.7
# Number of top scoring boxes to keep before apply NMS to RPN proposals
# __C.TRAIN.RPN_PRE_NMS_TOP_N = 12000
__C.TRAIN.RPN_PRE_NMS_TOP_N = 2500
...
__C.TEST.RPN_PRE_NMS_TOP_N = 2500
## Number of top scoring boxes to keep after applying NMS to RPN proposals

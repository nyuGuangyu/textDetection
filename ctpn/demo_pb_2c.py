...
from lib.rpn_msr.proposal_layer_tf_2c import proposal_layer
    ...
    with open('data/results/' + 'res_{}.txt'.format(base_name.split('.')[0]), 'w') as f:
        for box in boxes:
            ...
            if box[8] >= 0.9:
               ...
               color = (255, 0, 0)
            # if lang == 1 and box[8] >= 0.10:
            #     color = (0,255,0)
            # elif lang == 2 and box[8] >= 0.10:
            #     color = (255,0,0)
...
if __name__ == '__main__':
    ...
    with gfile.FastGFile('../data/ctpn_50000_2c.pb', 'rb') as f:
    ...
    for im_name in im_names:
        ...
        # boxes_lang1 = textdetector.detect(boxes, scores_lang1[:, np.newaxis], img.shape[:2],1)
        # boxes_lang2 = textdetector.detect(boxes, scores_lang2[:, np.newaxis], img.shape[:2],2)

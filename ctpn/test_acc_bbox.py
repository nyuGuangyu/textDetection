...
import pyximport
pyximport.install()
from lib.fast_rcnn.test_bbox import get_training_roidb, train_net
...
if __name__ == '__main__':
    ...
    print('Using config:')
    pprint.pprint(cfg)
    imdb = get_imdb('voc_2007_trainval', isTrain=False)
    ...
    train_net(network, imdb, roidb,
              ...
              max_iters=13700,
              restore=True,
              isTrain=False) # isTrain = False means using _ocr_test dataset otherwise it uses _ocr
